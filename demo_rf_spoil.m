...
t_grad = 1e-3;
G_amp = 1 / (gamma * t_grad * voxel_width); 
...
for n = 1:nTR
    [RF, Grads] = make_sequence(n_steps_TR, B1_amp, t_rf, 0, dt, G_amp, t_grad);
...
for n = 1:nTR
    ...
    [RF, Grads] = make_sequence(n_steps_TR, B1_amp, t_rf, phase_rad, dt, G_amp, t_grad);
    [M_final, M_hist] = bloch_evolve_active_indexed(Spins, RF, Grads, dt, true);
...
%% ===== 辅助函数集 =====
function [RF, Grads] = make_sequence(n_steps, B1_val, t_rf, phase, dt, G_val, t_grad)
